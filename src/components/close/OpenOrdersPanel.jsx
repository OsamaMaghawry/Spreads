...
export default function OpenOrdersPanel({ accountId, orders, onChange }) {
  ...
  return (
    <div className="bg-amber-50 border border-amber-200 rounded-lg p-3 space-y-2">
      ...
      {orders.map((o) => (
        <div key={o.id} className="flex items-center gap-3 bg-white border border-slate-200 rounded-lg px-3 py-2 text-xs">
          <div className="min-w-0">
            <div className="text-slate-800 capitalize tabular-nums">
          ...
          <button
            ...
            className="ml-auto shrink-0 flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-amber-100 text-amber-800 border border-amber-300 hover:bg-amber-200 transition-colors disabled:opacity-50"
          >
