...
// already begun.
//
// THIS WAS REMOVED ONCE, AND ALPACA SENT IT BACK. On 27 Aug it was taken out on
// the reading that Alpaca's own "Authorize <app>" page was the disclosure the
// DDQ meant. Alpaca's compliance team, reviewing the application, then set as a
// condition: "Confirm authorization disclosure is shown in DeltaMint UI before
// Alpaca redirect (video starts at Alpaca auth page)." That is the broker's own
// reading of its own requirement, and it settles the question the other way.
// Do not remove it again on the old argument.
//
