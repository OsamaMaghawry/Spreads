...
export default function UpgradePrompt({ message }) {
  // While the payment surface is off there is nowhere to send them, so the
  // prompt says what still works and stops — a button to a page that answers
  // "not open yet" is worse than no button.
