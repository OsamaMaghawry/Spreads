export default function DisclaimerFooter() {
  return (
    <footer className="border-t border-dm-line px-5 sm:px-10 py-5 text-[11px] leading-relaxed text-dm-sub">
      ...
      risk of loss and is not suitable for every investor. Trades are placed through your own brokerage
      account, under that broker's terms — DeltaMint never holds your funds or securities.
      {" "}
