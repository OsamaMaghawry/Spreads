...
// until a rebuild recomputes them. It is labelled so it is obvious those rows
// are stale rather than a category anyone should be choosing.
export const STRATEGIES = [
  ...
  { key: "wheel", label: "Wheel (needs rebuild)", badge: "bg-orange-100 text-orange-700" },
